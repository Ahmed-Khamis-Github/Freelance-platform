					...
					<div class="messages-container-inner">
						...
						<div class="messages-inbox">
							...
							<ul>
								<li>
									<a href="#">
										<div class="message-avatar"><i class="status-icon status-online"></i><img src="{{ asset('assets/front/images/user-avatar-small-03.jpg') }}" alt="" /></div>
								...
								<li class="active-message">
									<a href="#">
										<div class="message-avatar"><i class="status-icon status-offline"></i><img src="{{ asset('assets/front/images/user-avatar-small-02.jpg') }}" alt="" /></div>
								...
								<li>
									<a href="#">
										<div class="message-avatar"><i class="status-icon status-offline"></i><img src="{{ asset('assets/front/images/user-avatar-placeholder.png') }}" alt="" /></div>
								...
								<li>
									<a href="#">
										<div class="message-avatar"><i class="status-icon status-online"></i><img src="{{ asset('assets/front/images/user-avatar-placeholder.png') }}" alt="" /></div>
						...
						<div class="message-content">
							...
							<div class="message-reply">
								...
								<textarea cols="1" rows="1" placeholder="Your Message" data-autoresize name="message"></textarea>
