            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="single-page-header-inner">
                        <div class="left-side">
                            <div class="header-image"><a href="single-company-profile.html"><img src="{{asset('assets/front/images/company-logo-03a.png')}}" alt=""></a></div>
                            <div class="header-details">
                                ...
                                <ul>
                                    ...
                                    <li><img class="flag" src="{{asset('assets/front/images/flags/gb.svg')}}" alt=""> United Kingdom</li>
                    ...
                    <div class="listings-container grid-layout">
                            ...
                            <a href="#" class="job-listing">
                                ...
                                <div class="job-listing-details">
                                    <!-- Logo -->
                                    <div class="job-listing-company-logo">
                                        <img src="{{asset('assets/front/images/company-logo-03.png')}}" alt="">
                                    </div>
                    ...
                    <form method="post" action="{{ route('freelancer.proposals.store',$project->id) }}"  id="apply-now-form">
                        ...
                        <div class="form-group">
                          ...
                          <div class="form-group">
                           ...
                           <div class="form-group">
                             <select name="duration_unit" class="form-control" id="exampleFormControlSelect1">
