				...
				<div class="header-widget">
					...
					<div class="header-notifications user-menu">
						<div class="header-notifications-trigger">
							...
							<a href="#"><div class="user-avatar status-online"><img src="{{ Auth::user()->profile_photo }}" alt=""></div></a>
							@endauth
						...
						<div class="header-notifications-dropdown">
							...
							<div class="user-status">
								...
								<div class="user-details">
									...
									<div class="user-avatar status-online"><img src="{{ Auth::user()->profile_photo }}" alt=""></div>
									@endauth
...
<!-- Google API -->
<script src="{{asset('assets/front/https://maps.googleapis.com/maps/api/js?key=&libraries=places&callback=initAutocomplete')}}"></script>
