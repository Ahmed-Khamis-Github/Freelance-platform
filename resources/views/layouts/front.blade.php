                                    ...
                                    <div class="header-notifications-dropdown">
                                        ...
                                        <div class="user-status">
                                            ...
                                            <div class="user-details">
                                                <div class="user-avatar status-online"><img
                                                        ...
                                                        alt=""></div>
                                                <div class="user-name">
                                                    {{ Auth::guard('web')->user()->name ?? Auth::guard('admin')->user()->name }}
                                        ...
                                        <ul class="user-menu-small-nav">
                                            ...
                                            <form id="form1" action="{{ route('logout') }}" method="post">
                                                @csrf
                                                <a href="javascript:;" class="icon-material-outline-power-settings-new"
                                                    onclick="document.getElementById('form1').submit();"> Logout</a>
...
================================================== -->
    ...
    {{-- <script src="{{ asset('echo/app.js') }}"></script> --}}
